...
| `data-derechos` | `derechos-y-datos.md` (export + borrado/anonimización, arts. 15-20) |
| `data-consent-text` | `derechos-y-datos.md` (captura de consentimiento, art. 7) |
| `data-minimizacion` | `derechos-y-datos.md` (conservación/purga, art. 5.1.e) |
| `fact-*` (Veri*Factu) | `facturacion.md` (integrar un proveedor conforme en vez de implementar hash/QR a mano) |
...
(certificación UNE 19601, representación en una inspección, declaración responsable del fabricante) no se
construye con código (ver `cuando-acudir-a-abogado.md`).
