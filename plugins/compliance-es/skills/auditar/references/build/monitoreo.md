...
desactivado, export masivo de datos personales, acceso a la integración de facturación, registro de brecha.
...
## Conexión con la obligación legal (brechas, arts. 33-34 RGPD)
La detección temprana es lo que te permite cumplir el plazo de **72 horas** de notificación a la AEPD
(art. 33). El monitoreo no es la notificación: alimenta el **plan de respuesta a brechas**
(`packs/rgpd-lopdgdd/templates/plan-respuesta-brechas.md`) y el **registro de brechas** (art. 33.5).
