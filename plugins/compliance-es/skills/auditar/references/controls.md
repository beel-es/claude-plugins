...
| id | Control | RGPD + LOPDGDD (Datos) | LSSI + otros (lssi-cookies / radar) | Compliance penal (31 bis) | Veri*Factu (Facturación) | Ref. cruzada (ISO 27001 / SOC 2 / ENS) | Fuente de evidencia |
|----|---------|------------------------|-------------------------------------|---------------------------|--------------------------|----------------------------------|---------------------|
...
| `data-licitud` | Base de licitud / consentimiento | Sí (art. 6) | consentimiento cookies/marketing (arts. 21 y 22.2 LSSI) | — | — | GDPR Art.6 | código (formularios) |
| `data-consent-text` | Texto de consentimiento + revocación | Sí (arts. 7, 4.11) | aceptación de términos y cookies | — | — | GDPR Art.7 | docs + código |
...
| `data-info` | Deber de información (privacidad por capas) | Sí (arts. 13-14) | aviso legal (art. 10 LSSI) | — | — | GDPR Art.13 | código + docs |
...
| `lssi-aviso-legal` | Aviso legal completo y accesible (footer) | deber de información | Sí (art. 10 LSSI) | — | — | — | código (páginas legales) |
| `lssi-cookies` | Banner + bloqueo previo + inventario de cookies | consentimiento (art. 7) | Sí (art. 22.2 LSSI + guía AEPD) | — | — | — | código (frontend/tags) |
| `lssi-comunicaciones` | Emails comerciales con opt-in y baja | oposición (art. 21 RGPD) | Sí (arts. 21-22.1 LSSI) | — | — | — | código (email/marketing) |
| `lssi-contratacion` | Info precontractual + confirmación en 24 h | — | Sí (arts. 27-28 LSSI) | — | — | — | código (flujo de alta/pago) |
| `data-consent-records` | Registro versionado de aceptaciones (términos/privacidad/cookies) con hash e histórico inmutable | Sí (arts. 5.2, 7.1) | Sí (art. 27.1.b LSSI) | evidencia del modelo | — | ISO A.5.33 / SOC2 CC2 | código (tabla consent_records) |
| `data-act-switching` | Egress + terminación ≤2 meses + sin barreras de cambio | portabilidad (art. 20) | **Data Act** (arts. 23-31, aplicable 12-sep-2025) | — | — | — | código + términos |
| `a11y-eaa` | Accesibilidad WCAG 2.1 AA / EN 301 549 del flujo completo | — | **Ley 11/2023** (EAA, vigor 28-jun-2025; micro exenta) | — | — | — | código (frontend) + usuario |
| `ai-transparencia` | Transparencia de IA (avisar chatbot/contenido generado) + supervisión humana | decisiones automatizadas (art. 22) | **AI Act art. 50** (desde 2-ago-2026) | — | — | — | código (features de IA) |
