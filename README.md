...
| Skill | What it does |
|-------|--------------|
| `/beel-api:beel-api` | Integration guide: golden rules, auth, doc lookup strategy, plus recipes (typed client / official SDK, webhook handler, invoice flow, fiscal context, debugging, [`@beel_es/cli`](https://github.com/beel-es/beel-cli) to verify flows against Test) |
...
See the [plugin README](plugins/spring-boot-multitenancy/README.md).
